...
namespace IssueTracker.Controllers
{
    ...
    public class UsersController : Controller
    {
        ...
        public ActionResult Create()
        {
            ...
            model.RoleSelectListItem = new SelectList(_db.Roles, "Name", "Name");
            return View(model);
        }
        ...
        public ActionResult Create([Bind(Include = "Id,Email,EmailConfirmed,PasswordHash,SecurityStamp,PhoneNumber,PhoneNumberConfirmed,TwoFactorEnabled,LockoutEndDateUtc,LockoutEnabled,AccessFailedCount,UserName")] ApplicationUser applicationUser)
        {
            if (ModelState.IsValid)
            {
                ...
                _db.SaveChanges();
                ApplicationUser user = _db.Users.SingleOrDefault(users => users.UserName == applicationUser.UserName);
        ...
        public ActionResult Edit(Guid? id)
        {
            ...
            applicationUser.RoleId = _db.UserRole.Where(x => x.UserId == applicationUser.Id).Select(y => y.RoleId).FirstOrDefault();
            applicationUser.RoleSelectListItem = new SelectList(_db.Roles, "Id", "Name");
            if (applicationUser == null)
            {
                return HttpNotFound();
            }
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                var user = new ApplicationUser { UserName = model.Email, Email = model.Email, PhoneNumber = model.PhoneNumber, Id = Guid.NewGuid() };
                var result = await UserManager.CreateAsync(user, model.Password);
                UserManager.AddToRole(user.Id, model.RoleId.ToString());
                if (result.Succeeded)
                {
