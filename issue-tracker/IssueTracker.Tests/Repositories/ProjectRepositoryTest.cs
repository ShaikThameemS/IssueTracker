...
namespace IssueTracker.Tests.Repositories
{
    ...
    public class ProjectRepositoryTest
    {
        ...
        public void GetProjectCodeTest()
        {
            ...
            Mock<IProject_X_UsersRepository> fakeProjectUsersRepo = new Mock<IProject_X_UsersRepository>();

            var projectService = new ProjectService(fakeProjectRepo.Object, fakeIssueRepo.Object, fakeUserRepo.Object, fakeProjectUsersRepo.Object);
